...
public class Constants {
	...
	final public static int VISION_POINT_1_OCLOCK = 1;
	final public static int VISION_POINT_2_OCLOCK = 2;
	final public static int VISION_POINT_3_OCLOCK = 3;
	final public static int VISION_POINT_4_OCLOCK = 4;
	final public static int VISION_POINT_5_OCLOCK = 5;
	final public static int VISION_POINT_6_OCLOCK = 6;
	final public static int VISION_POINT_7_OCLOCK = 7;
	final public static int VISION_POINT_8_OCLOCK = 8;
	final public static int VISION_POINT_9_OCLOCK = 9;
	final public static int VISION_POINT_10_OCLOCK = 10;
	final public static int VISION_POINT_11_OCLOCK = 11;
