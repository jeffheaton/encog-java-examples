...
public class PredictSunspotCL {
	...
	public void train(BasicNetwork network,NeuralDataSet training)
	{
		...
		final ResilientPropagation train = new ResilientPropagation(network, training, null);

		EncogUtility.trainToError(train, network, training, MAX_ERROR);
	...
	public static void main(String args[])
	{
		...
		PredictSunspotCL sunspot = new PredictSunspotCL();
		sunspot.run();
	}
